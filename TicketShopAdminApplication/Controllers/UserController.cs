...
namespace TicketShopAdminApplication.Controllers
{
    public class UserController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            string URL = "https://localhost:5001/api/Admin/GetUsers";
        ...
        public IActionResult ChangeRole(User model)
        {
            ...
            string URL = "https://localhost:5001/api/Admin/ChangeRole";
        ...
        public IActionResult ImportUsers(IFormFile file)
        {
            ...
            string URL = "https://localhost:5001/api/Admin/ImportAllUsers";
